...
- Exam 2: EDA, ANOVA (including mean change analysis between baseline and end of study), and ANCOVA for serum-creatine. Checking of assumptions. GLM model assessing impact of NAPAP level on serum-creatine.
- HW2: ROC curves (sensitivity and specificity) for logistic models.
- HW3: Randomized sampling and group assignment method
